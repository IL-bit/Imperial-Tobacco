            ...
            {state.value === 1 && (
                <div id="1">
                    <div id="card_1">
                        ...
                        <div className="info">
                            <h2>Джек — смелый и свободолюбивый пират + еще текст в три строки <span>20.06.2024</span></h2>
                            <p>Капитан Джек это собирательный образ смелого и свободолюбивого пирата, любящего приключения, эксперименты и не привыкшего скучать.</p>
                            <p>Он из тех, кто предпочтёт вступить в схватку со стихией, а не отсиживаться дома в вязаных носках у камина.</p>
                            <p>Наш морской волк знает толк в качественной выпивке и табаке.</p>
                            <p>Капитан по достоинству оценил бы новые сигареты Сaptain Jack, ведь при их производстве мы используем<br/>премиальный табак Вирджиния и исключительно натуральные ароматизаторы.</p>
                            <p>Captain Jack является символом свободы, смелости непоколебимой решимости отправиться в новое плавание в поисках сокровищ и приключений.</p>
                        </div>
                    </div>
                    <div id="card_1">
                        <div className="head"></div>
